...
namespace Techievibe.Hub.API.Controllers.Users
{
    ...
    public class UserAccountsController : ControllerBase
    {
        ...
        /// <summary>
        /// A controller for managing user operations
        /// </summary>
        ...
        public async Task<IActionResult> DeleteUser(int userId)
        {
            ...
            watch.Stop();
            return Ok(new ApiResponse<string>("User(s) Deleted", 200, null, watch.ElapsedMilliseconds.ToString()));
        }
    }
}
