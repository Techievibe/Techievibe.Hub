    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                c.EnableAnnotations();
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Techievibe.Hub.AuthManagement.API", Version = "1.0.0" });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwagger(c =>
            {
                c.RouteTemplate = "api/auth-mgmt/swagger/{documentName}/swagger.json";
            });

            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/api/auth-mgmt/swagger/v1/swagger.json", "Techievibe.Hub.AuthManagement.API");
                c.RoutePrefix = "api/auth-mgmt/swagger";
            });
